...
def handle_biome_choice(available_biomes, animal, arboretum):
        ...
        if choice == "x":
            ...
            if selected_biome.name == "Forest":
                animal_accepted = arboretum.forests[original_biome_index].add_animal(animal)
                if animal_accepted == False:
                    build_biome_choices(animal, arboretum, animal_accepted)
            if selected_biome.name == "Grassland":
                animal_accepted = arboretum.grasslands[original_biome_index].add_animal(animal)
                if animal_accepted == False:
                    build_biome_choices(animal, arboretum, animal_accepted)
            if selected_biome.name == "Mountain":
                animal_accepted = arboretum.mountains[original_biome_index].add_animal(animal)
                if animal_accepted == False:
                    build_biome_choices(animal, arboretum, animal_accepted)
            if selected_biome.name == "River":
                animal_accepted = arboretum.rivers[original_biome_index].add_animal(animal)
                if animal_accepted == False:
                    build_biome_choices(animal, arboretum, animal_accepted)
            if selected_biome.name == "Swamp":
                animal_accepted = arboretum.swamps[original_biome_index].add_animal(animal)
                if animal_accepted == False:
                    build_biome_choices(animal, arboretum, animal_accepted)